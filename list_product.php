<?php
	...
	if(isset($_GET['did']))
	{
			...
			$execute=array();
			$exe_find_sr_no=find("first",ITEM,"*", "where id=".base64_decode($_GET['did']), $execute);
			$image=$exe_find_sr_no['image'];
			if($image)
			{
			  $imagepath='item_img/';
			...
			$del=delete(ITEM, $where_clause);
			if($del)
				{
				 $_SESSION['SET_TYPE'] = 'success';
				 $_SESSION['SET_FLASH'] = 'Product deleted successfully';
	...
	if(isset($_POST['search_btn']))
	{
		...
		$where="where code like '%".$_SESSION['search']."%'";
	...
	$where_clause="".$where."";
    $execute=array();
	$exe_find=find("all",ITEM,"*", $where_clause, $execute);
	...
	// }
	$fetch_data=find("all", ITEM, '*', $where_clause, $execute=array());
	//echo $where_clause;
...
function del_pic(id)
{
	...
	if (r == true) {
		window.location.href="list_product.php?did="+id;
	}
}
function edit_pic(id)
{
		window.location.href="edit_product.php?eid="+id;
}


 function btn(n)
  {
	  window.location.href="list_product.php?page="+n;
  }
  function btn_prev()
  {
	  window.location.href="list_product.php?page="+<?php echo $page-1?>;
  }
   function btn_next()
  {
	  window.location.href="list_product.php?page="+<?php echo $page+1?>;
       ...
       <div class="content-main">
		...
		<div class="content-top">
				...
				<?php 
					...
					{
				?>
					<h4 style="margin-bottom:20px;">Product List</h4>
					<div class="table-responsive">          
					  <table class="table table-bordered text-center">
						...
						<tr>
					        ...
					        <td><?php echo $qt['code']?></td>
					        <td><img src="item_img/<?php echo $qt['image']?>" style="width: 50px; height: 50px;"></td>
					        <td><?php echo $qt['price'];?></td>
